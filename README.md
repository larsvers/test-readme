...
![disputes](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/disputes.jpg)
...
![cities](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/cities.jpg)

<sub>Data source: [maxmind](http://www.maxmind.com/). Not equal area projected.</sub>

#### Farmers Markets in the US

![farmer markets](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/markets.jpg)

<sub>Data source: [USDA](https://www.ams.usda.gov/local-food-directories/farmersmarkets)</sub>

#### Post boxes in the UK 

![postboxes](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/postboxes.jpg)
...
![edge comparison](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/edge-compare.jpg)
...
![grid object](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/grid-object.jpg)
...
* `layout` is an array of arrays, each sub-array representing a hexagon in the grid. Each sub-array holds all point locations per hexagon in an object exposing at least _x_ and _y_ pixel coordinates as well as aggregate values. Here's an example hexagon layout sub-array with three point locations (or _datapoints_):
	...
	![layout object](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/layout-object.jpg)
...
![layout-object-vars](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/layout-object-vars.jpg)
...
![gridExtend](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/gridExtend.jpg)
...
![mercator](https://raw.githubusercontent.com/larsvers/image-store/master/d3-hexbin/cities.jpg/mercator.jpg)
